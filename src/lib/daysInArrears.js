...
export const DAYS_IN_ARREARS_BUCKETS = [
  '0-30',
  '31-90',
  '91-120',
  '121-180',
...
export function getDaysInArrearsBucket(days) {
...
export function getDaysInArrearsBadgeClass(days) {
 ...
 */
export function parseDaysInArrears(raw) {
